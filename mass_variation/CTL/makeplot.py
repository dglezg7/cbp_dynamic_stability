...
fig.tight_layout()
if (sys.argv[1] == 'pdf'):
    plt.savefig('masses_CTL.pdf', bbox_inches="tight", 
                dpi = 200)
if (sys.argv[1] == 'png'):
    plt.savefig('masses_CTL.png', bbox_inches="tight",
               dpi = 200)
